...
const profileCopy = {
  pt:{
    categories:{
      ...
      abilities:['Poder / manifestação','Capacidade documentada','Funcionamento conhecido','Usuários, interfaces e confrontos','Limites e consequências'],
      weapons:['Arma / equipamento','Uso documentado','Origem e funcionamento','Portadores, poderes e confrontos','Função tática e narrativa'],
      technology:['Tecnologia','Sistema documentado','Origem e funcionamento','Operadores, instituições e casos','Aplicações, riscos e limites']
    },
